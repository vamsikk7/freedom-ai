...
export default function SignUpPage() {
  ...
  const handleOtpSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.user.createdNewUser) {
        // Could redirect to onboarding or dashboard
      }
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="appearance-none block w-full px-4 py-3 bg-slate-900/50 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                ...
                <div className="flex justify-center gap-2">
                  {otp.map((digit, index) => (
                    <input
                      ...
                      className="w-12 h-14 text-center text-xl font-bold bg-slate-900/50 border border-slate-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                      autoFocus={index === 0}
                    />
                  ))}
                </div>
